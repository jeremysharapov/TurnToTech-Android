...
//    ConstraintLayout lay;
    ...
    public static Spinner backColor;
    public static Spinner clockColor;
    public static Spinner timeZone;
    public static final String prefs_name = "MyClockPreference";
...
//        lay = (ConstraintLayout)findViewById(R.id.lay1);
        ...
        check.setChecked(settings.getBoolean("24h", false));
        backColor.setSelection(settings.getInt("backCol", 0));
        clockColor.setSelection(settings.getInt("digCol", 0));
        timeZone.setSelection(settings.getInt("timeDif", 0));
    }
...
//        public void run(){
//            offSet = 4;
//            switch (String.valueOf(backColor.getSelectedItem())){
//                case "BLUE": back = BLUE;
//                    break;
//                case "RED": back = RED;
//                    break;
...
//            }
//
//            switch (String.valueOf(clockColor.getSelectedItem())){
//                case "BLUE": dig = BLUE;
//                    break;
//                case "RED": dig = RED;
//                    break;
...
//            }
//
//            switch (String.valueOf(timeZone.getSelectedItem())){
//                case "-12": offSet += -12;
//                    break;
//                case "-11": offSet += -11;
//                    break;
...
//    }
    ...
    public void buttonClicked(View view){
        ...
        editor.putInt("backCol", backColor.getSelectedItemPosition());
        editor.putInt("digCol", clockColor.getSelectedItemPosition());
        editor.putInt("timeDif", timeZone.getSelectedItemPosition());
        editor.putBoolean("24h", check.isChecked());
        editor.commit();
